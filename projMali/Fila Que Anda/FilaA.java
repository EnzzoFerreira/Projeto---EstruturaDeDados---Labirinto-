...
public class FilaA <X> implements Cloneable
{
    ...
    public FilaA (int tamanho) throws Exception
    {
        if (tamanho<=0)
    ...
    // construtor de copia
    public FilaA (FilaA<X> modelo) throws Exception
    {
        if(modelo == null)
